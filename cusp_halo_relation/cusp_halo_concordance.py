...
class CuspHaloStandard(cusp_halo.CuspHalo):
  ...
  def __init__(self,cutoff,include_baryons,h=0.6736,OmegaM=0.3089,OmegaB=0.04886,n_s=0.9649,A_s=2.100e-9,sigma8=None,transfer='table',Mhm=None,khm=None,lhm=None,amin=None,amax=1.,model_params=None,verbose=True):
    ...
    if model_params is None:
      model_params = cusp_halo.default_params
    super().__init__(k,P*T(k)**2,growth=growth,rho=rho,amin=amin,amax=amax,model_params=model_params,verbose=verbose)
...
class CuspHaloWDM(CuspHaloStandard):
  ...
  '''
  def __init__(self,cutoff='VA23',mX=None,Mhm=None,h=0.6736,OmegaM=0.3089,OmegaB=0.04886,spin=0.5,n_s=0.9649,A_s=2.100e-9,sigma8=None,transfer='table',amin=None,amax=1.,model_params=None,verbose=True):
    ...
    super().__init__(T,include_baryons=True,h=h,OmegaM=OmegaM,OmegaB=OmegaB,n_s=n_s,A_s=A_s,sigma8=sigma8,transfer=transfer,Mhm=Mhm,amin=amin,amax=amax,model_params=model_params,verbose=verbose)
    if verbose:
